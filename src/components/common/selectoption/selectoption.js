...
export const CampaignTypeOptions = [
  ...
  { value: "Webinars and Online Events", label: "Webinars and Online Events" },
  { value: "Advertising Campaigns", label: "Advertising Campaigns" },
  { value: "Onboarding Programs", label: "Onboarding Programs" },
  { value: "Lead Nurturing", label: "Lead Nurturing" },
  { value: "Cold/Warm Calling", label: "Cold/Warm Calling" },
  { value: "Drip Campaigns", label: "Drip Campaigns" },
  { value: "Product/Service Demos", label: "Product/Service Demos" },
  { value: "collaboration", label: "collaboration" },
  { value: "Retargeting Campaigns", label: "Retargeting Campaigns" },
];
...
export const ModuleOptions = [
  ...
  {path: route.callPurpose, label: "Call Purpose", value: "Call Purpose",},
  {path: route.callType, label: "Call Types", value: "Call Types",},
  {path: route.callResult, label: "Call Result", value: "Call Result",},
